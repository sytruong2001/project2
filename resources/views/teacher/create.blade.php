              ...
              <form action="{{ route('teacher.store')}}" method="post">
                ...
                <div class="card-body">
                  <div class="form-group">
                    ...
                    <input type="text" name="firstName"  class="form-control" id="exampleInputEmail1" placeholder="Nhập tên giảng viên">
                  </div>
                  <div class="form-group">
                    <label for="exampleInputEmail1">Tên đệm</label>
                    <input type="text" name="middleName" class="form-control" id="exampleInputEmail1" placeholder="Nhập tên đệm">
                  </div>
                  <div class="form-group">
                    <label for="exampleInputEmail1">Họ</label>
                    <input type="text" name="lastName" class="form-control" id="exampleInputEmail1" placeholder="Nhập họ">
                  </div>
                  <div class="form-group">

        ...
        <div class="row">
          ...
          <div class="col-md-12">
            ...
            <div class="card card-primary">
              ...
              <!-- /.card-header -->
              <!-- form start -->
              <form action="{{ route('teacher.insert-excel-process')}}" method="post" enctype="multipart/form-data">
                <input type="hidden" name="_token" value="{{ csrf_token() }}">
                <div class="card-body">
                  <div class="form-group">
                    <label for="exampleInputEmail1">Yêu cầu file phải đầy đủ các cột sau: Họ, Tên đệm, Tên, Giới tính, Email, Số điện thoại, Địa chỉ, Ngày sinh, Mật khẩu</label>
